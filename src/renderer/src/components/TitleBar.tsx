  ...
  return (
    <header className="titlebar">
      <div className="brand">
        <span className="logo">
          <svg viewBox="0 0 24 24" fill="none">
            <circle cx="12" cy="11" r="7" stroke="#3ECFB5" strokeWidth="1.6" />
            <path
            ...
            />
            <circle cx="12" cy="11" r="1.4" fill="#3ECFB5" />
            <path
      ...
      <div className="win-btns">
        <button className="win-btn" onClick={() => window.api.window.minimize()} title="Minimize">
